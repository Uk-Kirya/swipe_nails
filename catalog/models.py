...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, blank=True, null=True, on_delete=models.SET_NULL, verbose_name='Категория', related_name='products')
    style = models.ForeignKey(Style, blank=True, null=True, on_delete=models.SET_NULL, verbose_name='Стиль', related_name='products')
    color = models.ForeignKey(Color, blank=True, null=True, on_delete=models.SET_NULL, verbose_name='Цвет', related_name='products')
    acessories = models.ForeignKey(AccessoriesCategory, blank=True, null=True, on_delete=models.SET_NULL, verbose_name='Категория аксессура', related_name='products')
